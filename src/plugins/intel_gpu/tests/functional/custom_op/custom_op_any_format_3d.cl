// 3D-output companion to custom_op_any_format.cl. A rank-3 output takes a different
// path through the output-layout construction (get_default_format(3) rather than (4)),
// and is the shape the original defect was found on.
